...
urlpatterns = [
    ...
    path('pos/', views.POSView.as_view(), name='pos_view'), # This is the main POS page
    ...
    # You can keep your old invoice URLs if you still need them for a back-office interface
