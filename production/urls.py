...
from production.blueprints import cost_analysis_exports_blueprint
from . import views
from .blueprints import bom_exports_blueprint, draw_blueprint, category_size_blueprint
...
draw_patterns = [
    ...
    path('ajax/get-draws-for-bom/', draw_blueprint.get_draws_for_bom_ajax, name='ajax_get_draws_for_bom'),
]
...
exit_permit_patterns = [
    ...
    path('<int:pk>/receipt/', views.ExitPermitReceiptView.as_view(), name='exit_permit_receipt'),
...
urlpatterns = [
    ...
    # Categories and Size Groups Management
    path('categories-sizes/', category_size_blueprint.category_size_management_view, name='category_size_management'),
    ...
    # Textile Stock
    path('textile-stock/', views.TextileStockListView.as_view(), name='textile_stock_list'),
    path('textile-stock/create/', views.TextileStockCreateView.as_view(), name='textile_stock_create'),
    path('textile-stock/<int:pk>/', views.TextileStockDetailView.as_view(), name='textile_stock_detail'),
    path('textile-stock/<int:pk>/update/', views.TextileStockUpdateView.as_view(), name='textile_stock_update'),
    path('textile-stock/<int:pk>/delete/', views.TextileStockDeleteView.as_view(), name='textile_stock_delete'),
    path('textile-stock/<int:stock_id>/update-stock/', views.update_textile_stock, name='update_textile_stock'),
    path('textile-stock/bulk-update/', views.bulk_update_textile_stock, name='bulk_update_textile_stock'),

    # Finished Products
    path('finished-products/', views.FinishedProductListView.as_view(), name='finished_product_list'),
    path('finished-products/create/', views.FinishedProductCreateView.as_view(), name='finished_product_create'),
    path('finished-products/<int:pk>/', views.FinishedProductDetailView.as_view(), name='finished_product_detail'),
    path('finished-products/<int:pk>/update/', views.FinishedProductUpdateView.as_view(), name='finished_product_update'),
    path('finished-products/<int:pk>/delete/', views.FinishedProductDeleteView.as_view(), name='finished_product_delete'),
    ...
    path('ajax/get-finishing-costs/', views.ajax_get_finishing_costs, name='ajax_get_finishing_costs'), # NEW AJAX URL
    path('ajax/get-finishing-bom-components-for-dyeing/', views.ajax_get_finishing_bom_components_for_dyeing, name='ajax_get_finishing_bom_components_for_dyeing'), # ADDED AJAX URL
    ...
    path('quality/create/', views.QualityControlCreateView.as_view(), name='quality_create'),
    path('quality/<int:pk>/', views.QualityControlDetailView.as_view(), name='quality_detail'),
    path('quality/<int:pk>/approve/', views.approve_quality_check, name='quality_approve'),
    
    # Reports
    path('reports/', views.ProductionReportListView.as_view(), name='report_list'),
    path('reports/create/', views.ProductionReportCreateView.as_view(), name='report_create'),
    path('reports/<int:pk>/', views.ProductionReportDetailView.as_view(), name='report_detail'),
    path('reports/daily/', views.DailyProductionReportView.as_view(), name='daily_report'),
    path('reports/weekly/', views.WeeklyProductionReportView.as_view(), name='weekly_report'),
    path('reports/monthly/', views.MonthlyProductionReportView.as_view(), name='monthly_report'),
    path('reports/cost-analysis/', views.CostAnalysisReportView.as_view(), name='cost_analysis_report'),
    path('reports/quality/', views.QualityReportView.as_view(), name='quality_report'),
    path('textile-stock/<int:stock_id>/report/', views.textile_stock_report_view, name='textile_stock_report'),
    path('ajax/generate-textile-report/', views.generate_textile_report, name='generate_textile_report'),
    ...
    path('ajax/get-manufacturer-details/', views.get_manufacturer_details_ajax, name='get_manufacturer_details_ajax'),
    path('ajax/update-process-status/', views.update_process_status_ajax, name='update_process_status_ajax'),
    path('ajax/bulk-delete-orders/', views.bulk_delete_orders, name='bulk_delete_orders'),
    path('ajax/update-order-status/', views.update_order_status_ajax, name='update_order_status_ajax'),
    path('ajax/generate-batch/', views.batch_generator_view, name='batch_generator_view'),
    path('ajax/get-warehouse-products/', views.get_warehouse_products_ajax, name='get_warehouse_products_ajax'),
    path('ajax/get-finished-products/', views.get_finished_products_ajax, name='get_finished_products_ajax'),
    path('ajax/get-product-lead-time/', views.get_product_lead_time_ajax, name='get_product_lead_time'),
    path('ajax/get-textile-stock/', views.get_textile_stock_ajax, name='get_textile_stock_ajax'),
    ...
    path('ajax/update-cut-piece-quantity/', views.update_cut_piece_quantity_ajax, name='ajax_update_cut_piece_quantity'),
    path('ajax/create-exit-permit/', views.create_exit_permit_ajax, name='ajax_create_exit_permit'),
    ...
    # Export Views
    path('export/orders/', views.export_production_orders, name='export_orders'),
    path('export/textile-stock/', views.export_textile_stock, name='export_textile_stock'),
    path('export/textile-stock-detail/<int:stock_id>/', views.export_textile_stock_detail, name='export_textile_stock_detail'),
    path('export/stock-movements/<int:stock_item_id>/', views.export_stock_movements, name='export_stock_movements'),
    path('export/cost-analysis/', views.export_cost_analysis, name='export_cost_analysis'),
    path('export/quality-reports/', views.export_quality_reports, name='export_quality_reports'),
    path('export/finished-products/', views.export_finished_products, name='export_finished_products'),
    ...
    # BOM Export Views
    path('bom/<int:bom_id>/export/pdf/', bom_exports_blueprint.export_bom_pdf, name='bom_export_pdf'),
    path('bom/<int:bom_id>/export/csv/', bom_exports_blueprint.export_bom_csv, name='bom_export_csv'),
    path('bom/<int:bom_id>/export/excel/', bom_exports_blueprint.export_bom_excel, name='bom_export_excel'),

    # Print Views
    path('orders/<int:pk>/print/', views.print_production_order_pdf, name='print_production_order'),


    path('print/exit-permit/<int:pk>/', views.PrintExitPermitView.as_view(), name='print_exit_permit'),
    path('print/cutting-sheet/<int:pk>/', views.PrintCuttingSheetView.as_view(), name='print_cutting_sheet'),
    path('print/quality-report/<int:pk>/', views.PrintQualityReportView.as_view(), name='print_quality_report'),
