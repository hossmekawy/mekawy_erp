...
from warehouses.models import Product, Unit
...
# FIX: Use more descriptive names that the templates are looking for.
urlpatterns = [
    path('pdf/', export_bom_pdf, name='bom_export_pdf'),
    path('csv/', export_bom_csv, name='bom_export_csv'),
    path('excel/', export_bom_excel, name='bom_export_excel'),
]
